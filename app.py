...
Características:
- Lógica 100% en Python
- Validación de respuestas en backend
- Gemini AI para pistas contextuales cuando te equivocas
- Sistema de refuerzo cuando pierdes todas las llantas
- Sesiones para guardar progreso
"""
...
app = Flask(__name__)
app.secret_key = 'bus-aprendizaje-python-2025'
CORS(app)
...
def serve_animations_js():
    """Sirve el archivo de animaciones"""
    return send_from_directory('.', 'animations.js')
...
if __name__ == '__main__':
    print("\n" + "="*60)
    print("🚌 EL BUS DEL APRENDIZAJE EN PYTHON")
    print("Backend Flask + Gemini AI")
    print("="*60)
    ...
    if gemini_key:
        ...
        print("⚠️  Crea un archivo 'gemini.key' con tu API key de Gemini")
